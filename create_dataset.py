...
dress_patterns_df = pd.read_csv(r'data/dress_patterns.csv')
...
print(os.listdir())
os.mkdir(r'data/dataset_category')

for cat in category:
    print(cat)
    os.mkdir(r'data/dataset_category/'+cat)

print(os.listdir(r'data/dataset_category'))
...
for i in range(len(dress_patterns)):
  ...
  try:
    ...
    open(r'data/dataset_category/'+category+'/'+str(unit_id)+'.jpg', 'wb').write(r.content)
  except:
    print('ERROR at: ', i)
